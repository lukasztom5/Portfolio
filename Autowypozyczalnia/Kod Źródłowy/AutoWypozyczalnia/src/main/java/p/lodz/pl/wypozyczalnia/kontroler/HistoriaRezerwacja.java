...
@WebServlet(name="HistoriaRezerwacja", urlPatterns={"/HistoriaRezerwacja"})
public class HistoriaRezerwacja extends HttpServlet{
	...
	protected void processRequest(HttpServletRequest request,
		...
		String z=request.getParameter("zaliczka");
		...
		String zaliczka=new String("");
		if(z.startsWith("nie")){
			zaliczka="Niezaplacone";
		}else if(z.startsWith("tak")){
			zaliczka="Zaplacone";
		}
		...
		HistoriaWypozyczenia hw=new HistoriaWypozyczenia(idhistoria_wypozyczenia,idklient,idauta,marka,model,imie,nazwisko,
				terminWypozyczenia,terminOddania,LiczbaDni,CenaSegment,CenaDodatek,wyposazenie,Cena,zaliczka);
		try {
