...
@WebServlet(name="AktualneRezerwacja", urlPatterns={"/AktualneRezerwacja"})
public class AktualneRezerwacja extends HttpServlet{
	...
	protected void processRequest(HttpServletRequest request,
		...
		try {
			...
			if (result) {
				...
				response.sendRedirect("rezerwacja_cz2.jsp");
			}
			else {
