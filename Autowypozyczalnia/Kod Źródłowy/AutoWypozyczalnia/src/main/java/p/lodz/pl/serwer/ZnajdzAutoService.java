...
public class ZnajdzAutoService {
@SuppressWarnings("unchecked")
public List<Auta> findautabycolumn(String column, String value){
	...
	try{
		...
		t.begin();
		SQLQuery q = sess.createSQLQuery("select*from Auta where idauta not in (select autoid from aktualne_wypozyczenie) and "+ column+ "=" +"'" + value+ "'");
