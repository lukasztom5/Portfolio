...
@WebServlet(name = "KlientModify", urlPatterns = { "/KlientModify" })
public class KlientModify extends HttpServlet{
...
response.sendRedirect("client.jsp");	
	...
	else if(login.equals(a.getLOGIN()) || login.equals(k.getLOGIN()) || login.equals(p.getLOGIN())){
		response.sendRedirect("bladmodyfikacjiklienta.jsp");	
	}
	}
@Override
