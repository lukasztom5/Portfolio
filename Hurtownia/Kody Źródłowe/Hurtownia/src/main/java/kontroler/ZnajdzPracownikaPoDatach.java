...
@WebServlet(name="ZnajdzPracownikaPoDatach",urlPatterns={"/ZnajdzPracownikaPoDatach"})
public class ZnajdzPracownikaPoDatach extends HttpServlet {
	...
	List<Pracownik> lista= new ArrayList<Pracownik>();
		...
		lista=zppz.findpracownikbydata(request.getParameter("data1"), request.getParameter("data2"));
