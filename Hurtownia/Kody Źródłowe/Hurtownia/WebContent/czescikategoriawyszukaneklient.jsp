...
<table>
					...
					<tr>
						...
						<td><%=ud.getCena()+" zł"%></td>
						<td><a class="more"
							href="ZamowCzesc?idczesc=<%=c.getIDCZESC()%>">Do Koszyka</a></td>
