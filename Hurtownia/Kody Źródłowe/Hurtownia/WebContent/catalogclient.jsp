...
<table>
					...
					<tr>
						...
						<td><%=ud.getNazwa()%></td>
												...
												<td><a class="more"
							href="WybierzUrzadzenieK?idurzadzenie=<%=u.getIdurzadzenie()%>">Wybierz</a></td>
										<td><a class="more"
							href="WybierzKategoriaK?idurzadzenie=<%=u.getIdurzadzenie()%>">Wybierz</a></td>
					</tr>
...
<ul>
				 	<li>
					<a href="koszykklient.jsp">Twój Koszyk</a>
					</li></ul>
